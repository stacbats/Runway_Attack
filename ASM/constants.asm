...
.label ZeroPageTemp1Lo = $FB
.label ZeroPageTemp1Hi = $FC
.label ZeroPageTemp2Lo = $FD
.label ZeroPageTemp2Hi = $FE
...
.label SCREENRAM        = $0400         // $0400
.label SPRITE0          = SCREENRAM + $03F8  // $07F8
.label COLOURRAM        = $D800
.label COLOURRAMDifference = $D400
...
// 96 decimal * 64(sprite size) = 6144(hex $1800) = $5800 (+4000)
// 104 decimal * 64(sprite size) = 6656(hex $1A00) = $5A00 (+4000)
// 112 decimal * 64(sprite size) = 7168(hex $1C00) = $5C00 (+4000)
.label SPRITERAM       = 96 //$A0 //170
...
.label basicjmp_PrintString = $AB1E
.label basicjmp_MoveBytes = $A3BF
.label basicjmp_PrintWordInt = $BDCD
